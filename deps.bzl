...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:iOZoYePk+EuBI1tC7bxeRjO+JvClcYm2fZYW5WPIOMQ=",
        version = "v1.31.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:UBWojERnpCS6X7whJkGGZeCC3ruZBRwkwkcnfGfb0ko=",
        version = "v0.0.8",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_cristalhq_acmd",
        importpath = "github.com/cristalhq/acmd",
        sum = "h1:mtFp/cbeJNY5jokF9zPz5mRllGHropRrOkOVxeGS6FI=",
        version = "v0.8.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:qg5qEpjk1P1EMnInOCpxOpWSPRsspXJDT7P80y/JfFA=",
        version = "v0.0.0-20210623081221-ce222e317e36",
    )
    go_repository(
    ...
    go_repository(
        ...
        build_directives=["gazelle:build_tags unix"], #https://github.com/bazelbuild/bazel-gazelle/issues/1465
    ...
    go_repository(
        ...
        sum = "h1:IQ9CGHKOHokorxnffsqDvmmE30mDenO1lptYZ1AYkHY=",
        version = "v1.1.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:4IL4V8m/kI90ZL6GupCARZVrBv8/XrcKcJhaJ3iz68k=",
        version = "v7.0.50",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_pomerium_csrf",
        importpath = "github.com/pomerium/csrf",
        sum = "h1:Qp4t6oyEod3svQtKfJZs589mdUTWKVf7q0PgCKYCshY=",
        version = "v1.7.0",
    )
    go_repository(
        name = "com_github_pomerium_datasource",
        importpath = "github.com/pomerium/datasource",
        sum = "h1:3YQY1sb54tEEbr0L73rjHkpLB0IB6qh3zl1+XQbMLis=",
        version = "v0.18.2-0.20221108160055-c6134b5ed524",
    )
    go_repository(
        name = "com_github_pomerium_webauthn",
        importpath = "github.com/pomerium/webauthn",
        sum = "h1:oll/aOfJudnqFAwCvoXK9+WN2zVjTzHVPLXCggHQmHk=",
        version = "v0.0.0-20221118023040-00a9c430578b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:aJ7A7YI2lIvOxcJVeUZY4P6R7kKZtLeONjgyKGwOIu8=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_tniswong_go_rfcx",
        importpath = "github.com/tniswong/go.rfcx",
        sum = "h1:C43EMGXFtvYf/zunHR6ivZV7Z6ytg73t0GXwYyicXMQ=",
        version = "v0.0.0-20181019234604-07783c52761f",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:VV6qQFt+4sBBj9OJ7eKVvsFAMy59Urcs9Lgd+o5FOw0=",
        version = "v1.11.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_volatiletech_null_v9",
        importpath = "github.com/volatiletech/null/v9",
        sum = "h1:JCdlHEiSRVxOi7/MABiEfdsqmuj9oTV20Ao7VvZ0JkE=",
        version = "v9.0.0",
    )
    go_repository(
    ...
    go_repository(
        name = "dev_namespacelabs_go_filenotify",
        importpath = "namespacelabs.dev/go-filenotify",
        sum = "h1:jj2kjs0Hvufj40wuhMAzoZUOwrwMDFg1gHZ49RiIv9w=",
        version = "v0.0.0-20220511192020-53ea11be7eaa",
    )
    go_repository(
    ...
    go_repository(
        name = "in_gopkg_auth0_v5",
        importpath = "gopkg.in/auth0.v5",
        sum = "h1:aIqHBmnqaDv4eK2WSpTRsv2dEpT1jdHJPl+iwyDJNoo=",
        version = "v5.21.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3aSQdJ7EUC0ft2e9PjJB9Jzastz5ojPA4LzZ3Q4YbUc=",
        version = "v2.0.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:RjggHMcaTVp0LOVZcW0bo8alwHrOaCrGUDgfWUHhnN4=",
        version = "v0.0.0-20220930202632-ec3f01382ef9",
    )
    go_repository(
