...
func (fa *ForwardAuth) jwtClaimMiddleware(returnJWTInfo bool) mux.MiddlewareFunc {
	return func(next http.Handler) http.Handler {
		return httputil.HandlerFunc(func(w http.ResponseWriter, r *http.Request) error {
			...
			formattedJWTClaims, err := fa.getFormatedJWTClaims([]byte(jwt))
			if err != nil {
...
func (fa *ForwardAuth) getFormatedJWTClaims(jwt []byte) (map[string]string, error) {
	state := fa.state.Load()
