...
// Valid indicates whether the value is a known member of the BundleStatusFailureSource enum.
func (e BundleStatusFailureSource) Valid() bool {
	switch e {
	case DatabrokerError:
		return true
	case DownloadError:
		return true
	case InvalidBundle:
