...
type ClientInterface interface {
	...
	// GetClusterBootstrapConfig performs a GET /bootstrap (the `GetClusterBootstrapConfig` operationId) request.
	//
	// Get cluster bootstrap configuration.
	GetClusterBootstrapConfig(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetClusterResourceBundles performs a GET /bundles (the `GetClusterResourceBundles` operationId) request.
	//
	// Get all cluster resource bundles.
	GetClusterResourceBundles(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DownloadClusterResourceBundle performs a GET /bundles/{bundleId}/download (the `DownloadClusterResourceBundle` operationId) request.
	//
	// Download cluster resource bundle.
	DownloadClusterResourceBundle(ctx context.Context, bundleId BundleId, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ReportClusterResourceBundleStatusWithBody performs a POST /bundles/{bundleId}/status (the `ReportClusterResourceBundleStatus` operationId) request,
	// with any type of body and a specified content type.
	//
	// Report cluster resource bundle status.
	...
	// ReportClusterResourceBundleStatus performs a POST /bundles/{bundleId}/status (the `ReportClusterResourceBundleStatus` operationId) request.
	...
	// ImportConfigurationWithBody performs a PUT /config/import (the `ImportConfiguration` operationId) request,
	// with any type of body and a specified content type.
	//
	...
	// ExchangeClusterIdentityTokenWithBody performs a POST /exchangeToken (the `ExchangeClusterIdentityToken` operationId) request,
	// with any type of body and a specified content type.
	//
	// Exchange cluster identity token for bearer token.
	...
	// ExchangeClusterIdentityToken performs a POST /exchangeToken (the `ExchangeClusterIdentityToken` operationId) request.
	// Takes a body of the `application/json` content type.
	//
	// Exchange cluster identity token for bearer token.
	...
	// ReportUsageWithBody performs a POST /reportUsage (the `ReportUsage` operationId) request,
	// with any type of body and a specified content type.
	//
	// Report usage for the cluster.
	ReportUsageWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ReportUsage performs a POST /reportUsage (the `ReportUsage` operationId) request.
	// Takes a body of the `application/json` content type.
	//
	// Report usage for the cluster.
...
// NewGetClusterBootstrapConfigRequest constructs an http.Request for the GetClusterBootstrapConfig method
...
// NewGetClusterResourceBundlesRequest constructs an http.Request for the GetClusterResourceBundles method
...
// NewDownloadClusterResourceBundleRequest constructs an http.Request for the DownloadClusterResourceBundle method
...
// NewReportClusterResourceBundleStatusRequestWithBody constructs an http.Request for the ReportClusterResourceBundleStatus method, with any body, and a specified content type
...
// NewImportConfigurationRequestWithBody constructs an http.Request for the ImportConfiguration method, with any body, and a specified content type
func NewImportConfigurationRequestWithBody(server string, params *ImportConfigurationParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.XImportHints != nil {
			...
			headerParam0, err = runtime.StyleParamWithOptions("simple", true, "X-Import-Hints", *params.XImportHints, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationHeader, Type: "array", Format: ""})
			if err != nil {
				return nil, err
			}
...
// NewExchangeClusterIdentityTokenRequestWithBody constructs an http.Request for the ExchangeClusterIdentityToken method, with any body, and a specified content type
...
// NewReportUsageRequestWithBody constructs an http.Request for the ReportUsage method, with any body, and a specified content type
