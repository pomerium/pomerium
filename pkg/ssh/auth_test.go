...
func TestHandlePublicKeyMethodRequest(t *testing.T) {
	...
	t.Run("deny", func(t *testing.T) {
		...
		a := NewAuth(pe, nil, nil, nil)
		res, err := a.HandlePublicKeyMethodRequest(t.Context(), StreamAuthInfo{}, &req)
		assert.NoError(t, err)
...
func TestHandleKeyboardInteractiveMethodRequest(t *testing.T) {
	t.Run("no public key", func(t *testing.T) {
		var a Auth
		_, err := a.HandleKeyboardInteractiveMethodRequest(t.Context(), StreamAuthInfo{}, nil, nil)
	...
	t.Run("ok", func(t *testing.T) {
		...
		client := fakeDataBrokerServiceClient{
			get: func(
				ctx context.Context, in *databroker.GetRequest, opts ...grpc.CallOption,
			) (*databroker.GetResponse, error) {
				return nil, storage.ErrNotFound
			},
			put: func(
				ctx context.Context, in *databroker.PutRequest, opts ...grpc.CallOption,
	...
	t.Run("empty hostname", func(t *testing.T) {
		...
		cfg.Options.ClientID = "client-id"
		cfg.Options.ClientSecret = "client-secret"
		a := NewAuth(nil, client, atomicutil.NewValue(&cfg), nil)
		info := StreamAuthInfo{
			Username: "username",
			Hostname: "",
			PublicKeyAllow: AuthMethodValue[extensions_ssh.PublicKeyAllowResponse]{
