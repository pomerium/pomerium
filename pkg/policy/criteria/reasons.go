...
const (
	...
	ReasonPostgresApplicationNameOK           = "postgres-application-name-ok"
	ReasonPostgresApplicationNameUnauthorized = "postgres-application-name-unauthorized"
	ReasonPostgresDatabaseOK                  = "postgres-database-ok"
	ReasonPostgresDatabaseUnauthorized        = "postgres-database-unauthorized"
	ReasonPostgresStatementClassOK            = "postgres-statement-class-ok"
	ReasonPostgresStatementClassUnauthorized  = "postgres-statement-class-unauthorized"
	ReasonPostgresUsernameOK                  = "postgres-username-ok"
	ReasonPostgresUsernameUnauthorized        = "postgres-username-unauthorized"
	ReasonReject                              = "reject"
