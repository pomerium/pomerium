...
func (StreamAccessRequest_State) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_enumTypes[1].Descriptor()
}

func (StreamAccessRequest_State) Type() protoreflect.EnumType {
	return &file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_enumTypes[1]
}
...
func (StreamAccessRequest_State) EnumDescriptor() ([]byte, []int) {
	return file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_rawDescGZIP(), []int{6, 0}
}
...
func (*Handle) Descriptor() ([]byte, []int) {
	return file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_rawDescGZIP(), []int{8}
}
...
func (x *Session_DeviceCredential) Reset() {
	*x = Session_DeviceCredential{}
	mi := &file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
...
func file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_init() {
	...
	file_github_com_pomerium_pomerium_pkg_grpc_session_session_proto_msgTypes[9].OneofWrappers = []any{
