...
func (HealthCheck_HealthStatus) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{74, 0}
}
...
func (HealthCheck_CodecClientType) EnumDescriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{74, 1}
}
...
type Settings struct {
	...
	RecordingServer                  *RecordingServerSettings `protobuf:"bytes,177,opt,name=recording_server,json=recordingServer,proto3,oneof" json:"recording_server,omitempty"`
	BlobStorage                      *BlobStorageSettings     `protobuf:"bytes,178,opt,name=blob_storage,json=blobStorage,proto3,oneof" json:"blob_storage,omitempty"`
...
func (x *Settings) GetRecordingServer() *RecordingServerSettings {
	if x != nil {
		return x.RecordingServer
	}
	return nil
}
...
type RecordingServerSettings struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	Enabled              *bool                  `protobuf:"varint,1,opt,name=enabled,proto3,oneof" json:"enabled,omitempty"`
	MaxConcurrentStreams *int32                 `protobuf:"varint,2,opt,name=max_concurrent_streams,json=maxConcurrentStreams,proto3,oneof" json:"max_concurrent_streams,omitempty"`
	MaxChunkBatchNum     *int32                 `protobuf:"varint,3,opt,name=max_chunk_batch_num,json=maxChunkBatchNum,proto3,oneof" json:"max_chunk_batch_num,omitempty"`
	MaxChunkSize         *int32                 `protobuf:"varint,4,opt,name=max_chunk_size,json=maxChunkSize,proto3,oneof" json:"max_chunk_size,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}

func (x *RecordingServerSettings) Reset() {
	*x = RecordingServerSettings{}
	mi := &file_config_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RecordingServerSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecordingServerSettings) ProtoMessage() {}

func (x *RecordingServerSettings) ProtoReflect() protoreflect.Message {
	mi := &file_config_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RecordingServerSettings.ProtoReflect.Descriptor instead.
func (*RecordingServerSettings) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{18}
}

func (x *RecordingServerSettings) GetEnabled() bool {
...
func (x *RecordingServerSettings) GetMaxConcurrentStreams() int32 {
...
func (x *RecordingServerSettings) GetMaxChunkBatchNum() int32 {
	if x != nil && x.MaxChunkBatchNum != nil {
		return *x.MaxChunkBatchNum
	}
	return 0
}

func (x *RecordingServerSettings) GetMaxChunkSize() int32 {
...
func (*HealthCheck_Payload) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{74, 2}
}
...
func (*HealthCheck_HttpHealthCheck) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{74, 3}
}
...
func (*HealthCheck_TcpHealthCheck) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{74, 4}
}
...
func (*HealthCheck_GrpcHealthCheck) Descriptor() ([]byte, []int) {
	return file_config_proto_rawDescGZIP(), []int{74, 5}
}
...
const file_config_proto_rawDesc = "" +
	...
	"\"directory_provider_refresh_timeout\x18\xae\x01 \x01(\v2\x19.google.protobuf.DurationHvR\x1fdirectoryProviderRefreshTimeout\x88\x01\x01\x12Y\n" +
	"\x10recording_server\x18\xb1\x01 \x01(\v2(.pomerium.config.RecordingServerSettingsHwR\x0frecordingServer\x88\x01\x01\x12M\n" +
	"\fblob_storage\x18\xb2\x01 \x01(\v2$.pomerium.config.BlobStorageSettingsHxR\vblobStorage\x88\x01\x01\x12:\n" +
	"\n" +
	...
	"#_directory_provider_refresh_timeoutB\x13\n" +
	"\x11_recording_serverB\x0f\n" +
	...
	"\v_bucket_uriB\x11\n" +
	"\x0f_managed_prefix\"\xa4\x02\n" +
	"\x17RecordingServerSettings\x12\x1d\n" +
	"\aenabled\x18\x01 \x01(\bH\x00R\aenabled\x88\x01\x01\x129\n" +
	"\x16max_concurrent_streams\x18\x02 \x01(\x05H\x01R\x14maxConcurrentStreams\x88\x01\x01\x122\n" +
	"\x13max_chunk_batch_num\x18\x03 \x01(\x05H\x02R\x10maxChunkBatchNum\x88\x01\x01\x12)\n" +
	"\x0emax_chunk_size\x18\x04 \x01(\x05H\x03R\fmaxChunkSize\x88\x01\x01B\n" +
	"\n" +
	"\b_enabledB\x19\n" +
	"\x17_max_concurrent_streamsB\x16\n" +
	"\x14_max_chunk_batch_numB\x11\n" +
	"\x0f_max_chunk_size\"\x85\x03\n" +
...
var file_config_proto_goTypes = []any{
	...
	(*RecordingServerSettings)(nil),         // 30: pomerium.config.RecordingServerSettings
	...
	(*ListKeyPairsRequest)(nil),             // 64: pomerium.config.ListKeyPairsRequest
	(*ListKeyPairsResponse)(nil),            // 65: pomerium.config.ListKeyPairsResponse
	(*ListPoliciesRequest)(nil),             // 66: pomerium.config.ListPoliciesRequest
	(*ListPoliciesResponse)(nil),            // 67: pomerium.config.ListPoliciesResponse
	(*ListRoutesRequest)(nil),               // 68: pomerium.config.ListRoutesRequest
	(*ListRoutesResponse)(nil),              // 69: pomerium.config.ListRoutesResponse
	(*ListServiceAccountsRequest)(nil),      // 70: pomerium.config.ListServiceAccountsRequest
	(*ListServiceAccountsResponse)(nil),     // 71: pomerium.config.ListServiceAccountsResponse
	(*ListSettingsRequest)(nil),             // 72: pomerium.config.ListSettingsRequest
	(*ListSettingsResponse)(nil),            // 73: pomerium.config.ListSettingsResponse
	(*GetServerInfoRequest)(nil),            // 74: pomerium.config.GetServerInfoRequest
	(*GetServerInfoResponse)(nil),           // 75: pomerium.config.GetServerInfoResponse
	(*UpdateKeyPairRequest)(nil),            // 76: pomerium.config.UpdateKeyPairRequest
	(*UpdateKeyPairResponse)(nil),           // 77: pomerium.config.UpdateKeyPairResponse
	(*UpdatePolicyRequest)(nil),             // 78: pomerium.config.UpdatePolicyRequest
	(*UpdatePolicyResponse)(nil),            // 79: pomerium.config.UpdatePolicyResponse
	(*UpdateRouteRequest)(nil),              // 80: pomerium.config.UpdateRouteRequest
	(*UpdateRouteResponse)(nil),             // 81: pomerium.config.UpdateRouteResponse
	(*UpdateServiceAccountRequest)(nil),     // 82: pomerium.config.UpdateServiceAccountRequest
	(*UpdateServiceAccountResponse)(nil),    // 83: pomerium.config.UpdateServiceAccountResponse
	(*UpdateSettingsRequest)(nil),           // 84: pomerium.config.UpdateSettingsRequest
	(*UpdateSettingsResponse)(nil),          // 85: pomerium.config.UpdateSettingsResponse
	(*HealthCheck)(nil),                     // 86: pomerium.config.HealthCheck
	(*OutlierDetection)(nil),                // 87: pomerium.config.OutlierDetection
	(*VersionedConfig_Condition)(nil),       // 88: pomerium.config.VersionedConfig.Condition
	(*Route_StringList)(nil),                // 89: pomerium.config.Route.StringList
	nil,                                     // 90: pomerium.config.Route.AllowedIdpClaimsEntry
	nil,                                     // 91: pomerium.config.Route.SetRequestHeadersEntry
	nil,                                     // 92: pomerium.config.Route.SetResponseHeadersEntry
...
var file_config_proto_depIdxs = []int32{
	...
	88,  // 3: pomerium.config.VersionedConfig.conditions:type_name -> pomerium.config.VersionedConfig.Condition
	...
	90,  // 7: pomerium.config.Route.allowed_idp_claims:type_name -> pomerium.config.Route.AllowedIdpClaimsEntry
	...
	91,  // 10: pomerium.config.Route.set_request_headers:type_name -> pomerium.config.Route.SetRequestHeadersEntry
	92,  // 11: pomerium.config.Route.set_response_headers:type_name -> pomerium.config.Route.SetResponseHeadersEntry
	...
	89,  // 17: pomerium.config.Route.idp_access_token_allowed_audiences:type_name -> pomerium.config.Route.StringList
	...
	87,  // 21: pomerium.config.Route.outlier_detection:type_name -> pomerium.config.OutlierDetection
	86,  // 22: pomerium.config.Route.health_checks:type_name -> pomerium.config.HealthCheck
	...
	93,  // 33: pomerium.config.Policy.allowed_idp_claims:type_name -> pomerium.config.Policy.AllowedIdpClaimsEntry
	108, // 34: pomerium.config.Policy.created_at:type_name -> google.protobuf.Timestamp
	108, // 35: pomerium.config.Policy.modified_at:type_name -> google.protobuf.Timestamp
	...
	97,  // 38: pomerium.config.Settings.access_log_fields:type_name -> pomerium.config.Settings.StringList
	97,  // 39: pomerium.config.Settings.authorize_log_fields:type_name -> pomerium.config.Settings.StringList
	109, // 40: pomerium.config.Settings.dns_failure_refresh_rate:type_name -> google.protobuf.Duration
	109, // 41: pomerium.config.Settings.dns_query_timeout:type_name -> google.protobuf.Duration
	109, // 42: pomerium.config.Settings.dns_refresh_rate:type_name -> google.protobuf.Duration
	94,  // 43: pomerium.config.Settings.certificates:type_name -> pomerium.config.Settings.Certificate
	109, // 44: pomerium.config.Settings.timeout_read:type_name -> google.protobuf.Duration
	109, // 45: pomerium.config.Settings.timeout_write:type_name -> google.protobuf.Duration
	109, // 46: pomerium.config.Settings.timeout_idle:type_name -> google.protobuf.Duration
	109, // 47: pomerium.config.Settings.cookie_expire:type_name -> google.protobuf.Duration
	97,  // 48: pomerium.config.Settings.idp_access_token_allowed_audiences:type_name -> pomerium.config.Settings.StringList
	98,  // 49: pomerium.config.Settings.request_params:type_name -> pomerium.config.Settings.RequestParamsEntry
	99,  // 50: pomerium.config.Settings.set_response_headers:type_name -> pomerium.config.Settings.SetResponseHeadersEntry
	100, // 51: pomerium.config.Settings.jwt_claims_headers:type_name -> pomerium.config.Settings.JwtClaimsHeadersEntry
	...
	109, // 54: pomerium.config.Settings.default_upstream_timeout:type_name -> google.protobuf.Duration
	94,  // 55: pomerium.config.Settings.metrics_certificate:type_name -> pomerium.config.Settings.Certificate
	109, // 56: pomerium.config.Settings.otel_exporter_otlp_timeout:type_name -> google.protobuf.Duration
	109, // 57: pomerium.config.Settings.otel_exporter_otlp_traces_timeout:type_name -> google.protobuf.Duration
	109, // 58: pomerium.config.Settings.otel_bsp_schedule_delay:type_name -> google.protobuf.Duration
	109, // 59: pomerium.config.Settings.grpc_client_timeout:type_name -> google.protobuf.Duration
	96,  // 60: pomerium.config.Settings.databroker_cluster_nodes:type_name -> pomerium.config.Settings.DataBrokerClusterNodes
	31,  // 61: pomerium.config.Settings.downstream_mtls:type_name -> pomerium.config.DownstreamMtlsSettings
	7,   // 62: pomerium.config.Settings.codec_type:type_name -> pomerium.config.CodecType
	101, // 63: pomerium.config.Settings.runtime_flags:type_name -> pomerium.config.Settings.RuntimeFlagsEntry
	17,  // 64: pomerium.config.Settings.circuit_breaker_thresholds:type_name -> pomerium.config.CircuitBreakerThresholds
	97,  // 65: pomerium.config.Settings.ssh_host_key_files:type_name -> pomerium.config.Settings.StringList
	97,  // 66: pomerium.config.Settings.ssh_host_keys:type_name -> pomerium.config.Settings.StringList
	110, // 67: pomerium.config.Settings.directory_provider_options:type_name -> google.protobuf.Struct
	109, // 68: pomerium.config.Settings.directory_provider_refresh_interval:type_name -> google.protobuf.Duration
	109, // 69: pomerium.config.Settings.directory_provider_refresh_timeout:type_name -> google.protobuf.Duration
	30,  // 70: pomerium.config.Settings.recording_server:type_name -> pomerium.config.RecordingServerSettings
	29,  // 71: pomerium.config.Settings.blob_storage:type_name -> pomerium.config.BlobStorageSettings
	108, // 72: pomerium.config.Settings.created_at:type_name -> google.protobuf.Timestamp
	108, // 73: pomerium.config.Settings.modified_at:type_name -> google.protobuf.Timestamp
	3,   // 74: pomerium.config.DownstreamMtlsSettings.enforcement:type_name -> pomerium.config.MtlsEnforcementMode
	32,  // 75: pomerium.config.DownstreamMtlsSettings.match_subject_alt_names:type_name -> pomerium.config.SANMatcher
	9,   // 76: pomerium.config.SANMatcher.san_type:type_name -> pomerium.config.SANMatcher.SANType
	108, // 77: pomerium.config.KeyPair.created_at:type_name -> google.protobuf.Timestamp
	108, // 78: pomerium.config.KeyPair.modified_at:type_name -> google.protobuf.Timestamp
	...
	36,  // 81: pomerium.config.KeyPair.certificate_info:type_name -> pomerium.config.CertificateInfo
	35,  // 82: pomerium.config.CertificateInfo.issuer:type_name -> pomerium.config.Name
	35,  // 83: pomerium.config.CertificateInfo.subject:type_name -> pomerium.config.Name
	108, // 84: pomerium.config.CertificateInfo.not_before:type_name -> google.protobuf.Timestamp
	108, // 85: pomerium.config.CertificateInfo.not_after:type_name -> google.protobuf.Timestamp
	34,  // 86: pomerium.config.CertificateInfo.key_usage:type_name -> pomerium.config.KeyUsage
	108, // 87: pomerium.config.ServiceAccount.expires_at:type_name -> google.protobuf.Timestamp
	108, // 88: pomerium.config.ServiceAccount.created_at:type_name -> google.protobuf.Timestamp
	108, // 89: pomerium.config.ServiceAccount.modified_at:type_name -> google.protobuf.Timestamp
	108, // 90: pomerium.config.ServiceAccount.accessed_at:type_name -> google.protobuf.Timestamp
	33,  // 91: pomerium.config.CreateKeyPairRequest.key_pair:type_name -> pomerium.config.KeyPair
	33,  // 92: pomerium.config.CreateKeyPairResponse.key_pair:type_name -> pomerium.config.KeyPair
	...
	37,  // 97: pomerium.config.CreateServiceAccountRequest.service_account:type_name -> pomerium.config.ServiceAccount
	37,  // 98: pomerium.config.CreateServiceAccountResponse.service_account:type_name -> pomerium.config.ServiceAccount
	33,  // 99: pomerium.config.GetKeyPairResponse.key_pair:type_name -> pomerium.config.KeyPair
	...
	37,  // 102: pomerium.config.GetServiceAccountResponse.service_account:type_name -> pomerium.config.ServiceAccount
	28,  // 103: pomerium.config.GetSettingsResponse.settings:type_name -> pomerium.config.Settings
	110, // 104: pomerium.config.ListKeyPairsRequest.filter:type_name -> google.protobuf.Struct
	33,  // 105: pomerium.config.ListKeyPairsResponse.key_pairs:type_name -> pomerium.config.KeyPair
	110, // 106: pomerium.config.ListPoliciesRequest.filter:type_name -> google.protobuf.Struct
	27,  // 107: pomerium.config.ListPoliciesResponse.policies:type_name -> pomerium.config.Policy
	110, // 108: pomerium.config.ListRoutesRequest.filter:type_name -> google.protobuf.Struct
	19,  // 109: pomerium.config.ListRoutesResponse.routes:type_name -> pomerium.config.Route
	110, // 110: pomerium.config.ListServiceAccountsRequest.filter:type_name -> google.protobuf.Struct
	37,  // 111: pomerium.config.ListServiceAccountsResponse.service_accounts:type_name -> pomerium.config.ServiceAccount
	110, // 112: pomerium.config.ListSettingsRequest.filter:type_name -> google.protobuf.Struct
	...
	33,  // 115: pomerium.config.UpdateKeyPairRequest.key_pair:type_name -> pomerium.config.KeyPair
	33,  // 116: pomerium.config.UpdateKeyPairResponse.key_pair:type_name -> pomerium.config.KeyPair
	...
	37,  // 121: pomerium.config.UpdateServiceAccountRequest.service_account:type_name -> pomerium.config.ServiceAccount
	37,  // 122: pomerium.config.UpdateServiceAccountResponse.service_account:type_name -> pomerium.config.ServiceAccount
	...
	109, // 125: pomerium.config.HealthCheck.timeout:type_name -> google.protobuf.Duration
	109, // 126: pomerium.config.HealthCheck.interval:type_name -> google.protobuf.Duration
	109, // 127: pomerium.config.HealthCheck.initial_jitter:type_name -> google.protobuf.Duration
	109, // 128: pomerium.config.HealthCheck.interval_jitter:type_name -> google.protobuf.Duration
	111, // 129: pomerium.config.HealthCheck.unhealthy_threshold:type_name -> google.protobuf.UInt32Value
	111, // 130: pomerium.config.HealthCheck.healthy_threshold:type_name -> google.protobuf.UInt32Value
	111, // 131: pomerium.config.HealthCheck.alt_port:type_name -> google.protobuf.UInt32Value
	112, // 132: pomerium.config.HealthCheck.reuse_connection:type_name -> google.protobuf.BoolValue
	105, // 133: pomerium.config.HealthCheck.http_health_check:type_name -> pomerium.config.HealthCheck.HttpHealthCheck
	106, // 134: pomerium.config.HealthCheck.tcp_health_check:type_name -> pomerium.config.HealthCheck.TcpHealthCheck
	107, // 135: pomerium.config.HealthCheck.grpc_health_check:type_name -> pomerium.config.HealthCheck.GrpcHealthCheck
	109, // 136: pomerium.config.HealthCheck.no_traffic_interval:type_name -> google.protobuf.Duration
	109, // 137: pomerium.config.HealthCheck.no_traffic_healthy_interval:type_name -> google.protobuf.Duration
	109, // 138: pomerium.config.HealthCheck.unhealthy_interval:type_name -> google.protobuf.Duration
	109, // 139: pomerium.config.HealthCheck.unhealthy_edge_interval:type_name -> google.protobuf.Duration
	109, // 140: pomerium.config.HealthCheck.healthy_edge_interval:type_name -> google.protobuf.Duration
	110, // 141: pomerium.config.HealthCheck.transport_socket_match_criteria:type_name -> google.protobuf.Struct
	111, // 142: pomerium.config.OutlierDetection.consecutive_5xx:type_name -> google.protobuf.UInt32Value
	109, // 143: pomerium.config.OutlierDetection.interval:type_name -> google.protobuf.Duration
	109, // 144: pomerium.config.OutlierDetection.base_ejection_time:type_name -> google.protobuf.Duration
	111, // 145: pomerium.config.OutlierDetection.max_ejection_percent:type_name -> google.protobuf.UInt32Value
	111, // 146: pomerium.config.OutlierDetection.enforcing_consecutive_5xx:type_name -> google.protobuf.UInt32Value
	111, // 147: pomerium.config.OutlierDetection.enforcing_success_rate:type_name -> google.protobuf.UInt32Value
	111, // 148: pomerium.config.OutlierDetection.success_rate_minimum_hosts:type_name -> google.protobuf.UInt32Value
	111, // 149: pomerium.config.OutlierDetection.success_rate_request_volume:type_name -> google.protobuf.UInt32Value
	111, // 150: pomerium.config.OutlierDetection.success_rate_stdev_factor:type_name -> google.protobuf.UInt32Value
	111, // 151: pomerium.config.OutlierDetection.consecutive_gateway_failure:type_name -> google.protobuf.UInt32Value
	111, // 152: pomerium.config.OutlierDetection.enforcing_consecutive_gateway_failure:type_name -> google.protobuf.UInt32Value
	111, // 153: pomerium.config.OutlierDetection.consecutive_local_origin_failure:type_name -> google.protobuf.UInt32Value
	111, // 154: pomerium.config.OutlierDetection.enforcing_consecutive_local_origin_failure:type_name -> google.protobuf.UInt32Value
	111, // 155: pomerium.config.OutlierDetection.enforcing_local_origin_success_rate:type_name -> google.protobuf.UInt32Value
	111, // 156: pomerium.config.OutlierDetection.failure_percentage_threshold:type_name -> google.protobuf.UInt32Value
	111, // 157: pomerium.config.OutlierDetection.enforcing_failure_percentage:type_name -> google.protobuf.UInt32Value
	111, // 158: pomerium.config.OutlierDetection.enforcing_failure_percentage_local_origin:type_name -> google.protobuf.UInt32Value
	111, // 159: pomerium.config.OutlierDetection.failure_percentage_minimum_hosts:type_name -> google.protobuf.UInt32Value
	111, // 160: pomerium.config.OutlierDetection.failure_percentage_request_volume:type_name -> google.protobuf.UInt32Value
	109, // 161: pomerium.config.OutlierDetection.max_ejection_time:type_name -> google.protobuf.Duration
	109, // 162: pomerium.config.OutlierDetection.max_ejection_time_jitter:type_name -> google.protobuf.Duration
	112, // 163: pomerium.config.OutlierDetection.successful_active_health_check_uneject_host:type_name -> google.protobuf.BoolValue
	112, // 164: pomerium.config.OutlierDetection.always_eject_one_host:type_name -> google.protobuf.BoolValue
	113, // 165: pomerium.config.Route.AllowedIdpClaimsEntry.value:type_name -> google.protobuf.ListValue
	113, // 166: pomerium.config.Policy.AllowedIdpClaimsEntry.value:type_name -> google.protobuf.ListValue
	95,  // 167: pomerium.config.Settings.DataBrokerClusterNodes.nodes:type_name -> pomerium.config.Settings.DataBrokerClusterNode
	10,  // 168: pomerium.config.HealthCheck.HealthStatusSet.statuses:type_name -> pomerium.config.HealthCheck.HealthStatus
	104, // 169: pomerium.config.HealthCheck.HttpHealthCheck.send:type_name -> pomerium.config.HealthCheck.Payload
	104, // 170: pomerium.config.HealthCheck.HttpHealthCheck.receive:type_name -> pomerium.config.HealthCheck.Payload
	114, // 171: pomerium.config.HealthCheck.HttpHealthCheck.response_buffer_size:type_name -> google.protobuf.UInt64Value
	103, // 172: pomerium.config.HealthCheck.HttpHealthCheck.expected_statuses:type_name -> pomerium.config.HealthCheck.Int64Range
	103, // 173: pomerium.config.HealthCheck.HttpHealthCheck.retriable_statuses:type_name -> pomerium.config.HealthCheck.Int64Range
	...
	104, // 175: pomerium.config.HealthCheck.TcpHealthCheck.send:type_name -> pomerium.config.HealthCheck.Payload
	104, // 176: pomerium.config.HealthCheck.TcpHealthCheck.receive:type_name -> pomerium.config.HealthCheck.Payload
	38,  // 177: pomerium.config.ConfigService.CreateKeyPair:input_type -> pomerium.config.CreateKeyPairRequest
	40,  // 178: pomerium.config.ConfigService.CreatePolicy:input_type -> pomerium.config.CreatePolicyRequest
	42,  // 179: pomerium.config.ConfigService.CreateRoute:input_type -> pomerium.config.CreateRouteRequest
	44,  // 180: pomerium.config.ConfigService.CreateServiceAccount:input_type -> pomerium.config.CreateServiceAccountRequest
	46,  // 181: pomerium.config.ConfigService.DeleteKeyPair:input_type -> pomerium.config.DeleteKeyPairRequest
	48,  // 182: pomerium.config.ConfigService.DeletePolicy:input_type -> pomerium.config.DeletePolicyRequest
	50,  // 183: pomerium.config.ConfigService.DeleteRoute:input_type -> pomerium.config.DeleteRouteRequest
	52,  // 184: pomerium.config.ConfigService.DeleteServiceAccount:input_type -> pomerium.config.DeleteServiceAccountRequest
	54,  // 185: pomerium.config.ConfigService.GetKeyPair:input_type -> pomerium.config.GetKeyPairRequest
	56,  // 186: pomerium.config.ConfigService.GetPolicy:input_type -> pomerium.config.GetPolicyRequest
	58,  // 187: pomerium.config.ConfigService.GetRoute:input_type -> pomerium.config.GetRouteRequest
	74,  // 188: pomerium.config.ConfigService.GetServerInfo:input_type -> pomerium.config.GetServerInfoRequest
	60,  // 189: pomerium.config.ConfigService.GetServiceAccount:input_type -> pomerium.config.GetServiceAccountRequest
	62,  // 190: pomerium.config.ConfigService.GetSettings:input_type -> pomerium.config.GetSettingsRequest
	64,  // 191: pomerium.config.ConfigService.ListKeyPairs:input_type -> pomerium.config.ListKeyPairsRequest
	66,  // 192: pomerium.config.ConfigService.ListPolicies:input_type -> pomerium.config.ListPoliciesRequest
	68,  // 193: pomerium.config.ConfigService.ListRoutes:input_type -> pomerium.config.ListRoutesRequest
	70,  // 194: pomerium.config.ConfigService.ListServiceAccounts:input_type -> pomerium.config.ListServiceAccountsRequest
	72,  // 195: pomerium.config.ConfigService.ListSettings:input_type -> pomerium.config.ListSettingsRequest
	76,  // 196: pomerium.config.ConfigService.UpdateKeyPair:input_type -> pomerium.config.UpdateKeyPairRequest
	78,  // 197: pomerium.config.ConfigService.UpdatePolicy:input_type -> pomerium.config.UpdatePolicyRequest
	80,  // 198: pomerium.config.ConfigService.UpdateRoute:input_type -> pomerium.config.UpdateRouteRequest
	82,  // 199: pomerium.config.ConfigService.UpdateServiceAccount:input_type -> pomerium.config.UpdateServiceAccountRequest
	84,  // 200: pomerium.config.ConfigService.UpdateSettings:input_type -> pomerium.config.UpdateSettingsRequest
	39,  // 201: pomerium.config.ConfigService.CreateKeyPair:output_type -> pomerium.config.CreateKeyPairResponse
	41,  // 202: pomerium.config.ConfigService.CreatePolicy:output_type -> pomerium.config.CreatePolicyResponse
	43,  // 203: pomerium.config.ConfigService.CreateRoute:output_type -> pomerium.config.CreateRouteResponse
	45,  // 204: pomerium.config.ConfigService.CreateServiceAccount:output_type -> pomerium.config.CreateServiceAccountResponse
	47,  // 205: pomerium.config.ConfigService.DeleteKeyPair:output_type -> pomerium.config.DeleteKeyPairResponse
	49,  // 206: pomerium.config.ConfigService.DeletePolicy:output_type -> pomerium.config.DeletePolicyResponse
	51,  // 207: pomerium.config.ConfigService.DeleteRoute:output_type -> pomerium.config.DeleteRouteResponse
	53,  // 208: pomerium.config.ConfigService.DeleteServiceAccount:output_type -> pomerium.config.DeleteServiceAccountResponse
	55,  // 209: pomerium.config.ConfigService.GetKeyPair:output_type -> pomerium.config.GetKeyPairResponse
	57,  // 210: pomerium.config.ConfigService.GetPolicy:output_type -> pomerium.config.GetPolicyResponse
	59,  // 211: pomerium.config.ConfigService.GetRoute:output_type -> pomerium.config.GetRouteResponse
	75,  // 212: pomerium.config.ConfigService.GetServerInfo:output_type -> pomerium.config.GetServerInfoResponse
	61,  // 213: pomerium.config.ConfigService.GetServiceAccount:output_type -> pomerium.config.GetServiceAccountResponse
	63,  // 214: pomerium.config.ConfigService.GetSettings:output_type -> pomerium.config.GetSettingsResponse
	65,  // 215: pomerium.config.ConfigService.ListKeyPairs:output_type -> pomerium.config.ListKeyPairsResponse
	67,  // 216: pomerium.config.ConfigService.ListPolicies:output_type -> pomerium.config.ListPoliciesResponse
	69,  // 217: pomerium.config.ConfigService.ListRoutes:output_type -> pomerium.config.ListRoutesResponse
	71,  // 218: pomerium.config.ConfigService.ListServiceAccounts:output_type -> pomerium.config.ListServiceAccountsResponse
	73,  // 219: pomerium.config.ConfigService.ListSettings:output_type -> pomerium.config.ListSettingsResponse
	77,  // 220: pomerium.config.ConfigService.UpdateKeyPair:output_type -> pomerium.config.UpdateKeyPairResponse
	79,  // 221: pomerium.config.ConfigService.UpdatePolicy:output_type -> pomerium.config.UpdatePolicyResponse
	81,  // 222: pomerium.config.ConfigService.UpdateRoute:output_type -> pomerium.config.UpdateRouteResponse
	83,  // 223: pomerium.config.ConfigService.UpdateServiceAccount:output_type -> pomerium.config.UpdateServiceAccountResponse
	85,  // 224: pomerium.config.ConfigService.UpdateSettings:output_type -> pomerium.config.UpdateSettingsResponse
