...
type Route struct {
	...
	AllowTailscaleControlProtocol             bool                           `protobuf:"varint,120,opt,name=allow_tailscale_control_protocol,json=allowTailscaleControlProtocol,proto3" json:"allow_tailscale_control_protocol,omitempty"`
...
func (x *Route) GetAllowTailscaleControlProtocol() bool {
	if x != nil {
		return x.AllowTailscaleControlProtocol
	}
	return false
}
...
const file_config_proto_rawDesc = "" +
	...
	"\n" +
	"allow_spdy\x18, \x01(\bR\tallowSpdy\x12G\n" +
	" allow_tailscale_control_protocol\x18x \x01(\bR\x1dallowTailscaleControlProtocol\x12&\n" +
