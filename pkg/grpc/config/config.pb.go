...
var file_config_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xfb, 0x27,
	...
	0x65, 0x79, 0x41, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x88, 0x01, 0x01, 0x12, 0x5d,
	...
	0x6f, 0x6e, 0x48, 0x20, 0x52, 0x0f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x43, 0x6f, 0x6f,
	...
	0x09, 0x48, 0x26, 0x52, 0x13, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x43, 0x6c, 0x69, 0x65,
	...
	0x29, 0x20, 0x01, 0x28, 0x09, 0x48, 0x27, 0x52, 0x0f, 0x74, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67,
	...
	0x74, 0x65, 0x18, 0x2a, 0x20, 0x01, 0x28, 0x01, 0x48, 0x28, 0x52, 0x11, 0x74, 0x72, 0x61, 0x63,
	...
	0x5f, 0x75, 0x72, 0x6c, 0x18, 0x32, 0x20, 0x01, 0x28, 0x09, 0x48, 0x2e, 0x52, 0x0e, 0x66, 0x6f,
	...
	0x74, 0x5f, 0x63, 0x61, 0x18, 0x35, 0x20, 0x01, 0x28, 0x09, 0x48, 0x2f, 0x52, 0x08, 0x63, 0x6c,
	...
	0x09, 0x48, 0x30, 0x52, 0x0c, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x61, 0x46, 0x69, 0x6c,
	...
	0x20, 0x01, 0x28, 0x09, 0x48, 0x31, 0x52, 0x31, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x43, 0x6c,
	...
	0x61, 0x75, 0x74, 0x6f, 0x63, 0x65, 0x72, 0x74, 0x18, 0x38, 0x20, 0x01, 0x28, 0x08, 0x48, 0x32,
	...
	0x61, 0x67, 0x69, 0x6e, 0x67, 0x18, 0x39, 0x20, 0x01, 0x28, 0x08, 0x48, 0x33, 0x52, 0x12, 0x61,
	...
	0x28, 0x08, 0x48, 0x34, 0x52, 0x12, 0x61, 0x75, 0x74, 0x6f, 0x63, 0x65, 0x72, 0x74, 0x4d, 0x75,
	...
	0x09, 0x48, 0x35, 0x52, 0x0b, 0x61, 0x75, 0x74, 0x6f, 0x63, 0x65, 0x72, 0x74, 0x44, 0x69, 0x72,
	0x88, 0x01, 0x01, 0x12, 0x2b, 0x0a, 0x0f, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x78, 0x66, 0x66, 0x5f,
	0x61, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x18, 0x3d, 0x20, 0x01, 0x28, 0x08, 0x48, 0x36, 0x52, 0x0d,
	...
	0x5f, 0x78, 0x66, 0x66, 0x5f, 0x61, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x42, 0x2e, 0x5a, 0x2c, 0x67,
...
var file_config_proto_goTypes = []interface{}{
	...
	nil,                          // 11: pomerium.config.Settings.JwtClaimsHeadersEntry
	(*durationpb.Duration)(nil),  // 12: google.protobuf.Duration
	(*v3.Cluster)(nil),           // 13: envoy.config.cluster.v3.Cluster
...
var file_config_proto_depIdxs = []int32{
	...
	12, // 4: pomerium.config.Route.timeout:type_name -> google.protobuf.Duration
	...
	13, // 7: pomerium.config.Route.envoy_opts:type_name -> envoy.config.cluster.v3.Cluster
	...
	12, // 11: pomerium.config.Settings.timeout_read:type_name -> google.protobuf.Duration
	12, // 12: pomerium.config.Settings.timeout_write:type_name -> google.protobuf.Duration
	12, // 13: pomerium.config.Settings.timeout_idle:type_name -> google.protobuf.Duration
	12, // 14: pomerium.config.Settings.cookie_expire:type_name -> google.protobuf.Duration
	12, // 15: pomerium.config.Settings.idp_refresh_directory_timeout:type_name -> google.protobuf.Duration
	12, // 16: pomerium.config.Settings.idp_refresh_directory_interval:type_name -> google.protobuf.Duration
	10, // 17: pomerium.config.Settings.request_params:type_name -> pomerium.config.Settings.RequestParamsEntry
	11, // 18: pomerium.config.Settings.jwt_claims_headers:type_name -> pomerium.config.Settings.JwtClaimsHeadersEntry
	12, // 19: pomerium.config.Settings.refresh_cooldown:type_name -> google.protobuf.Duration
	12, // 20: pomerium.config.Settings.default_upstream_timeout:type_name -> google.protobuf.Duration
	9,  // 21: pomerium.config.Settings.metrics_certificate:type_name -> pomerium.config.Settings.Certificate
	12, // 22: pomerium.config.Settings.grpc_server_max_connection_age:type_name -> google.protobuf.Duration
	12, // 23: pomerium.config.Settings.grpc_server_max_connection_age_grace:type_name -> google.protobuf.Duration
	14, // 24: pomerium.config.Route.AllowedIdpClaimsEntry.value:type_name -> google.protobuf.ListValue
	14, // 25: pomerium.config.Policy.AllowedIdpClaimsEntry.value:type_name -> google.protobuf.ListValue
