...
var file_config_proto_msgTypes = make([]protoimpl.MessageInfo, 80)
var file_config_proto_goTypes = []any{
	...
	(*VersionedConfig_Condition)(nil),       // 71: pomerium.config.VersionedConfig.Condition
	(*Route_StringList)(nil),                // 72: pomerium.config.Route.StringList
	nil,                                     // 73: pomerium.config.Route.AllowedIdpClaimsEntry
	nil,                                     // 74: pomerium.config.Route.SetRequestHeadersEntry
	nil,                                     // 75: pomerium.config.Route.SetResponseHeadersEntry
	nil,                                     // 76: pomerium.config.Policy.AllowedIdpClaimsEntry
	(*Settings_Certificate)(nil),            // 77: pomerium.config.Settings.Certificate
	(*Settings_DataBrokerClusterNode)(nil),  // 78: pomerium.config.Settings.DataBrokerClusterNode
	(*Settings_DataBrokerClusterNodes)(nil), // 79: pomerium.config.Settings.DataBrokerClusterNodes
	(*Settings_StringList)(nil),             // 80: pomerium.config.Settings.StringList
	nil,                                     // 81: pomerium.config.Settings.RequestParamsEntry
	nil,                                     // 82: pomerium.config.Settings.SetResponseHeadersEntry
	nil,                                     // 83: pomerium.config.Settings.JwtClaimsHeadersEntry
	nil,                                     // 84: pomerium.config.Settings.RuntimeFlagsEntry
	(*HealthCheck_HealthStatusSet)(nil),     // 85: pomerium.config.HealthCheck.HealthStatusSet
	(*HealthCheck_Int64Range)(nil),          // 86: pomerium.config.HealthCheck.Int64Range
	(*HealthCheck_Payload)(nil),             // 87: pomerium.config.HealthCheck.Payload
	(*HealthCheck_HttpHealthCheck)(nil),     // 88: pomerium.config.HealthCheck.HttpHealthCheck
	(*HealthCheck_TcpHealthCheck)(nil),      // 89: pomerium.config.HealthCheck.TcpHealthCheck
	(*HealthCheck_GrpcHealthCheck)(nil),     // 90: pomerium.config.HealthCheck.GrpcHealthCheck
	...
	(*structpb.ListValue)(nil),              // 96: google.protobuf.ListValue
...
var file_config_proto_depIdxs = []int32{
	...
	71,  // 3: pomerium.config.VersionedConfig.conditions:type_name -> pomerium.config.VersionedConfig.Condition
	14,  // 4: pomerium.config.Route.redirect:type_name -> pomerium.config.RouteRedirect
	15,  // 5: pomerium.config.Route.response:type_name -> pomerium.config.RouteDirectResponse
	73,  // 6: pomerium.config.Route.allowed_idp_claims:type_name -> pomerium.config.Route.AllowedIdpClaimsEntry
	91,  // 7: pomerium.config.Route.timeout:type_name -> google.protobuf.Duration
	91,  // 8: pomerium.config.Route.idle_timeout:type_name -> google.protobuf.Duration
	74,  // 9: pomerium.config.Route.set_request_headers:type_name -> pomerium.config.Route.SetRequestHeadersEntry
	75,  // 10: pomerium.config.Route.set_response_headers:type_name -> pomerium.config.Route.SetResponseHeadersEntry
	13,  // 11: pomerium.config.Route.rewrite_response_headers:type_name -> pomerium.config.RouteRewriteHeader
	...
	25,  // 14: pomerium.config.Route.policies:type_name -> pomerium.config.Policy
	24,  // 15: pomerium.config.Route.ppl_policies:type_name -> pomerium.config.PPLPolicy
	72,  // 16: pomerium.config.Route.idp_access_token_allowed_audiences:type_name -> pomerium.config.Route.StringList
	19,  // 17: pomerium.config.Route.mcp:type_name -> pomerium.config.MCP
	16,  // 18: pomerium.config.Route.circuit_breaker_thresholds:type_name -> pomerium.config.CircuitBreakerThresholds
	18,  // 19: pomerium.config.Route.upstream_tunnel:type_name -> pomerium.config.UpstreamTunnel
	70,  // 20: pomerium.config.Route.outlier_detection:type_name -> pomerium.config.OutlierDetection
	69,  // 21: pomerium.config.Route.health_checks:type_name -> pomerium.config.HealthCheck
	7,   // 22: pomerium.config.Route.load_balancing_policy:type_name -> pomerium.config.LoadBalancingPolicy
	92,  // 23: pomerium.config.Route.created_at:type_name -> google.protobuf.Timestamp
	92,  // 24: pomerium.config.Route.modified_at:type_name -> google.protobuf.Timestamp
	20,  // 25: pomerium.config.MCP.server:type_name -> pomerium.config.MCPServer
	21,  // 26: pomerium.config.MCP.client:type_name -> pomerium.config.MCPClient
	22,  // 27: pomerium.config.MCPServer.upstream_oauth2:type_name -> pomerium.config.UpstreamOAuth2
	23,  // 28: pomerium.config.UpstreamOAuth2.oauth2_endpoint:type_name -> pomerium.config.OAuth2Endpoint
	2,   // 29: pomerium.config.OAuth2Endpoint.auth_style:type_name -> pomerium.config.OAuth2AuthStyle
	76,  // 30: pomerium.config.Policy.allowed_idp_claims:type_name -> pomerium.config.Policy.AllowedIdpClaimsEntry
	92,  // 31: pomerium.config.Policy.created_at:type_name -> google.protobuf.Timestamp
	92,  // 32: pomerium.config.Policy.modified_at:type_name -> google.protobuf.Timestamp
	80,  // 33: pomerium.config.Settings.access_log_fields:type_name -> pomerium.config.Settings.StringList
	80,  // 34: pomerium.config.Settings.authorize_log_fields:type_name -> pomerium.config.Settings.StringList
	91,  // 35: pomerium.config.Settings.dns_failure_refresh_rate:type_name -> google.protobuf.Duration
	91,  // 36: pomerium.config.Settings.dns_query_timeout:type_name -> google.protobuf.Duration
	91,  // 37: pomerium.config.Settings.dns_refresh_rate:type_name -> google.protobuf.Duration
	77,  // 38: pomerium.config.Settings.certificates:type_name -> pomerium.config.Settings.Certificate
	91,  // 39: pomerium.config.Settings.timeout_read:type_name -> google.protobuf.Duration
	91,  // 40: pomerium.config.Settings.timeout_write:type_name -> google.protobuf.Duration
	91,  // 41: pomerium.config.Settings.timeout_idle:type_name -> google.protobuf.Duration
	91,  // 42: pomerium.config.Settings.cookie_expire:type_name -> google.protobuf.Duration
	80,  // 43: pomerium.config.Settings.idp_access_token_allowed_audiences:type_name -> pomerium.config.Settings.StringList
	81,  // 44: pomerium.config.Settings.request_params:type_name -> pomerium.config.Settings.RequestParamsEntry
	82,  // 45: pomerium.config.Settings.set_response_headers:type_name -> pomerium.config.Settings.SetResponseHeadersEntry
	83,  // 46: pomerium.config.Settings.jwt_claims_headers:type_name -> pomerium.config.Settings.JwtClaimsHeadersEntry
	...
	91,  // 49: pomerium.config.Settings.default_upstream_timeout:type_name -> google.protobuf.Duration
	77,  // 50: pomerium.config.Settings.metrics_certificate:type_name -> pomerium.config.Settings.Certificate
	91,  // 51: pomerium.config.Settings.otel_exporter_otlp_timeout:type_name -> google.protobuf.Duration
	91,  // 52: pomerium.config.Settings.otel_exporter_otlp_traces_timeout:type_name -> google.protobuf.Duration
	91,  // 53: pomerium.config.Settings.otel_bsp_schedule_delay:type_name -> google.protobuf.Duration
	91,  // 54: pomerium.config.Settings.grpc_client_timeout:type_name -> google.protobuf.Duration
	79,  // 55: pomerium.config.Settings.databroker_cluster_nodes:type_name -> pomerium.config.Settings.DataBrokerClusterNodes
	27,  // 56: pomerium.config.Settings.downstream_mtls:type_name -> pomerium.config.DownstreamMtlsSettings
	6,   // 57: pomerium.config.Settings.codec_type:type_name -> pomerium.config.CodecType
	84,  // 58: pomerium.config.Settings.runtime_flags:type_name -> pomerium.config.Settings.RuntimeFlagsEntry
	16,  // 59: pomerium.config.Settings.circuit_breaker_thresholds:type_name -> pomerium.config.CircuitBreakerThresholds
	80,  // 60: pomerium.config.Settings.ssh_host_key_files:type_name -> pomerium.config.Settings.StringList
	80,  // 61: pomerium.config.Settings.ssh_host_keys:type_name -> pomerium.config.Settings.StringList
	92,  // 62: pomerium.config.Settings.created_at:type_name -> google.protobuf.Timestamp
	92,  // 63: pomerium.config.Settings.modified_at:type_name -> google.protobuf.Timestamp
	3,   // 64: pomerium.config.DownstreamMtlsSettings.enforcement:type_name -> pomerium.config.MtlsEnforcementMode
	28,  // 65: pomerium.config.DownstreamMtlsSettings.match_subject_alt_names:type_name -> pomerium.config.SANMatcher
	8,   // 66: pomerium.config.SANMatcher.san_type:type_name -> pomerium.config.SANMatcher.SANType
	92,  // 67: pomerium.config.KeyPair.created_at:type_name -> google.protobuf.Timestamp
	92,  // 68: pomerium.config.KeyPair.modified_at:type_name -> google.protobuf.Timestamp
	5,   // 69: pomerium.config.KeyPair.status:type_name -> pomerium.config.KeyPairStatus
	4,   // 70: pomerium.config.KeyPair.origin:type_name -> pomerium.config.KeyPairOrigin
	32,  // 71: pomerium.config.KeyPair.certificate_info:type_name -> pomerium.config.CertificateInfo
	31,  // 72: pomerium.config.CertificateInfo.issuer:type_name -> pomerium.config.Name
	31,  // 73: pomerium.config.CertificateInfo.subject:type_name -> pomerium.config.Name
	92,  // 74: pomerium.config.CertificateInfo.not_before:type_name -> google.protobuf.Timestamp
	92,  // 75: pomerium.config.CertificateInfo.not_after:type_name -> google.protobuf.Timestamp
	30,  // 76: pomerium.config.CertificateInfo.key_usage:type_name -> pomerium.config.KeyUsage
	29,  // 77: pomerium.config.CreateKeyPairRequest.key_pair:type_name -> pomerium.config.KeyPair
	29,  // 78: pomerium.config.CreateKeyPairResponse.key_pair:type_name -> pomerium.config.KeyPair
	25,  // 79: pomerium.config.CreatePolicyRequest.policy:type_name -> pomerium.config.Policy
	25,  // 80: pomerium.config.CreatePolicyResponse.policy:type_name -> pomerium.config.Policy
	17,  // 81: pomerium.config.CreateRouteRequest.route:type_name -> pomerium.config.Route
	17,  // 82: pomerium.config.CreateRouteResponse.route:type_name -> pomerium.config.Route
	29,  // 83: pomerium.config.GetKeyPairResponse.key_pair:type_name -> pomerium.config.KeyPair
	25,  // 84: pomerium.config.GetPolicyResponse.policy:type_name -> pomerium.config.Policy
	17,  // 85: pomerium.config.GetRouteResponse.route:type_name -> pomerium.config.Route
	26,  // 86: pomerium.config.GetSettingsResponse.settings:type_name -> pomerium.config.Settings
	29,  // 87: pomerium.config.ListKeyPairsResponse.key_pairs:type_name -> pomerium.config.KeyPair
	25,  // 88: pomerium.config.ListPoliciesResponse.policies:type_name -> pomerium.config.Policy
	17,  // 89: pomerium.config.ListRoutesResponse.routes:type_name -> pomerium.config.Route
	93,  // 90: pomerium.config.ListSettingsRequest.filter:type_name -> google.protobuf.Struct
	26,  // 91: pomerium.config.ListSettingsResponse.settings:type_name -> pomerium.config.Settings
	29,  // 92: pomerium.config.UpdateKeyPairRequest.key_pair:type_name -> pomerium.config.KeyPair
	29,  // 93: pomerium.config.UpdateKeyPairResponse.key_pair:type_name -> pomerium.config.KeyPair
	25,  // 94: pomerium.config.UpdatePolicyRequest.policy:type_name -> pomerium.config.Policy
	25,  // 95: pomerium.config.UpdatePolicyResponse.policy:type_name -> pomerium.config.Policy
	17,  // 96: pomerium.config.UpdateRouteRequest.route:type_name -> pomerium.config.Route
	17,  // 97: pomerium.config.UpdateRouteResponse.route:type_name -> pomerium.config.Route
	26,  // 98: pomerium.config.UpdateSettingsRequest.settings:type_name -> pomerium.config.Settings
	26,  // 99: pomerium.config.UpdateSettingsResponse.settings:type_name -> pomerium.config.Settings
	91,  // 100: pomerium.config.HealthCheck.timeout:type_name -> google.protobuf.Duration
	91,  // 101: pomerium.config.HealthCheck.interval:type_name -> google.protobuf.Duration
	91,  // 102: pomerium.config.HealthCheck.initial_jitter:type_name -> google.protobuf.Duration
	91,  // 103: pomerium.config.HealthCheck.interval_jitter:type_name -> google.protobuf.Duration
	94,  // 104: pomerium.config.HealthCheck.unhealthy_threshold:type_name -> google.protobuf.UInt32Value
	94,  // 105: pomerium.config.HealthCheck.healthy_threshold:type_name -> google.protobuf.UInt32Value
	94,  // 106: pomerium.config.HealthCheck.alt_port:type_name -> google.protobuf.UInt32Value
	95,  // 107: pomerium.config.HealthCheck.reuse_connection:type_name -> google.protobuf.BoolValue
	88,  // 108: pomerium.config.HealthCheck.http_health_check:type_name -> pomerium.config.HealthCheck.HttpHealthCheck
	89,  // 109: pomerium.config.HealthCheck.tcp_health_check:type_name -> pomerium.config.HealthCheck.TcpHealthCheck
	90,  // 110: pomerium.config.HealthCheck.grpc_health_check:type_name -> pomerium.config.HealthCheck.GrpcHealthCheck
	91,  // 111: pomerium.config.HealthCheck.no_traffic_interval:type_name -> google.protobuf.Duration
	91,  // 112: pomerium.config.HealthCheck.no_traffic_healthy_interval:type_name -> google.protobuf.Duration
	91,  // 113: pomerium.config.HealthCheck.unhealthy_interval:type_name -> google.protobuf.Duration
	91,  // 114: pomerium.config.HealthCheck.unhealthy_edge_interval:type_name -> google.protobuf.Duration
	91,  // 115: pomerium.config.HealthCheck.healthy_edge_interval:type_name -> google.protobuf.Duration
	93,  // 116: pomerium.config.HealthCheck.transport_socket_match_criteria:type_name -> google.protobuf.Struct
	94,  // 117: pomerium.config.OutlierDetection.consecutive_5xx:type_name -> google.protobuf.UInt32Value
	91,  // 118: pomerium.config.OutlierDetection.interval:type_name -> google.protobuf.Duration
	91,  // 119: pomerium.config.OutlierDetection.base_ejection_time:type_name -> google.protobuf.Duration
	94,  // 120: pomerium.config.OutlierDetection.max_ejection_percent:type_name -> google.protobuf.UInt32Value
	94,  // 121: pomerium.config.OutlierDetection.enforcing_consecutive_5xx:type_name -> google.protobuf.UInt32Value
	94,  // 122: pomerium.config.OutlierDetection.enforcing_success_rate:type_name -> google.protobuf.UInt32Value
	94,  // 123: pomerium.config.OutlierDetection.success_rate_minimum_hosts:type_name -> google.protobuf.UInt32Value
	94,  // 124: pomerium.config.OutlierDetection.success_rate_request_volume:type_name -> google.protobuf.UInt32Value
	94,  // 125: pomerium.config.OutlierDetection.success_rate_stdev_factor:type_name -> google.protobuf.UInt32Value
	94,  // 126: pomerium.config.OutlierDetection.consecutive_gateway_failure:type_name -> google.protobuf.UInt32Value
	94,  // 127: pomerium.config.OutlierDetection.enforcing_consecutive_gateway_failure:type_name -> google.protobuf.UInt32Value
	94,  // 128: pomerium.config.OutlierDetection.consecutive_local_origin_failure:type_name -> google.protobuf.UInt32Value
	94,  // 129: pomerium.config.OutlierDetection.enforcing_consecutive_local_origin_failure:type_name -> google.protobuf.UInt32Value
	94,  // 130: pomerium.config.OutlierDetection.enforcing_local_origin_success_rate:type_name -> google.protobuf.UInt32Value
	94,  // 131: pomerium.config.OutlierDetection.failure_percentage_threshold:type_name -> google.protobuf.UInt32Value
	94,  // 132: pomerium.config.OutlierDetection.enforcing_failure_percentage:type_name -> google.protobuf.UInt32Value
	94,  // 133: pomerium.config.OutlierDetection.enforcing_failure_percentage_local_origin:type_name -> google.protobuf.UInt32Value
	94,  // 134: pomerium.config.OutlierDetection.failure_percentage_minimum_hosts:type_name -> google.protobuf.UInt32Value
	94,  // 135: pomerium.config.OutlierDetection.failure_percentage_request_volume:type_name -> google.protobuf.UInt32Value
	91,  // 136: pomerium.config.OutlierDetection.max_ejection_time:type_name -> google.protobuf.Duration
	91,  // 137: pomerium.config.OutlierDetection.max_ejection_time_jitter:type_name -> google.protobuf.Duration
	95,  // 138: pomerium.config.OutlierDetection.successful_active_health_check_uneject_host:type_name -> google.protobuf.BoolValue
	95,  // 139: pomerium.config.OutlierDetection.always_eject_one_host:type_name -> google.protobuf.BoolValue
	96,  // 140: pomerium.config.Route.AllowedIdpClaimsEntry.value:type_name -> google.protobuf.ListValue
	96,  // 141: pomerium.config.Policy.AllowedIdpClaimsEntry.value:type_name -> google.protobuf.ListValue
	78,  // 142: pomerium.config.Settings.DataBrokerClusterNodes.nodes:type_name -> pomerium.config.Settings.DataBrokerClusterNode
	9,   // 143: pomerium.config.HealthCheck.HealthStatusSet.statuses:type_name -> pomerium.config.HealthCheck.HealthStatus
	87,  // 144: pomerium.config.HealthCheck.HttpHealthCheck.send:type_name -> pomerium.config.HealthCheck.Payload
	87,  // 145: pomerium.config.HealthCheck.HttpHealthCheck.receive:type_name -> pomerium.config.HealthCheck.Payload
	97,  // 146: pomerium.config.HealthCheck.HttpHealthCheck.response_buffer_size:type_name -> google.protobuf.UInt64Value
	86,  // 147: pomerium.config.HealthCheck.HttpHealthCheck.expected_statuses:type_name -> pomerium.config.HealthCheck.Int64Range
	86,  // 148: pomerium.config.HealthCheck.HttpHealthCheck.retriable_statuses:type_name -> pomerium.config.HealthCheck.Int64Range
	10,  // 149: pomerium.config.HealthCheck.HttpHealthCheck.codec_client_type:type_name -> pomerium.config.HealthCheck.CodecClientType
	87,  // 150: pomerium.config.HealthCheck.TcpHealthCheck.send:type_name -> pomerium.config.HealthCheck.Payload
	87,  // 151: pomerium.config.HealthCheck.TcpHealthCheck.receive:type_name -> pomerium.config.HealthCheck.Payload
	33,  // 152: pomerium.config.ConfigService.CreateKeyPair:input_type -> pomerium.config.CreateKeyPairRequest
	35,  // 153: pomerium.config.ConfigService.CreatePolicy:input_type -> pomerium.config.CreatePolicyRequest
	37,  // 154: pomerium.config.ConfigService.CreateRoute:input_type -> pomerium.config.CreateRouteRequest
	39,  // 155: pomerium.config.ConfigService.DeleteKeyPair:input_type -> pomerium.config.DeleteKeyPairRequest
	41,  // 156: pomerium.config.ConfigService.DeletePolicy:input_type -> pomerium.config.DeletePolicyRequest
	43,  // 157: pomerium.config.ConfigService.DeleteRoute:input_type -> pomerium.config.DeleteRouteRequest
	45,  // 158: pomerium.config.ConfigService.GetKeyPair:input_type -> pomerium.config.GetKeyPairRequest
	47,  // 159: pomerium.config.ConfigService.GetPolicy:input_type -> pomerium.config.GetPolicyRequest
	49,  // 160: pomerium.config.ConfigService.GetRoute:input_type -> pomerium.config.GetRouteRequest
	51,  // 161: pomerium.config.ConfigService.GetSettings:input_type -> pomerium.config.GetSettingsRequest
	53,  // 162: pomerium.config.ConfigService.ListKeyPairs:input_type -> pomerium.config.ListKeyPairsRequest
	55,  // 163: pomerium.config.ConfigService.ListPolicies:input_type -> pomerium.config.ListPoliciesRequest
	57,  // 164: pomerium.config.ConfigService.ListRoutes:input_type -> pomerium.config.ListRoutesRequest
	59,  // 165: pomerium.config.ConfigService.ListSettings:input_type -> pomerium.config.ListSettingsRequest
	61,  // 166: pomerium.config.ConfigService.UpdateKeyPair:input_type -> pomerium.config.UpdateKeyPairRequest
	63,  // 167: pomerium.config.ConfigService.UpdatePolicy:input_type -> pomerium.config.UpdatePolicyRequest
	65,  // 168: pomerium.config.ConfigService.UpdateRoute:input_type -> pomerium.config.UpdateRouteRequest
	67,  // 169: pomerium.config.ConfigService.UpdateSettings:input_type -> pomerium.config.UpdateSettingsRequest
	34,  // 170: pomerium.config.ConfigService.CreateKeyPair:output_type -> pomerium.config.CreateKeyPairResponse
	36,  // 171: pomerium.config.ConfigService.CreatePolicy:output_type -> pomerium.config.CreatePolicyResponse
	38,  // 172: pomerium.config.ConfigService.CreateRoute:output_type -> pomerium.config.CreateRouteResponse
	40,  // 173: pomerium.config.ConfigService.DeleteKeyPair:output_type -> pomerium.config.DeleteKeyPairResponse
	42,  // 174: pomerium.config.ConfigService.DeletePolicy:output_type -> pomerium.config.DeletePolicyResponse
	44,  // 175: pomerium.config.ConfigService.DeleteRoute:output_type -> pomerium.config.DeleteRouteResponse
	46,  // 176: pomerium.config.ConfigService.GetKeyPair:output_type -> pomerium.config.GetKeyPairResponse
	48,  // 177: pomerium.config.ConfigService.GetPolicy:output_type -> pomerium.config.GetPolicyResponse
	50,  // 178: pomerium.config.ConfigService.GetRoute:output_type -> pomerium.config.GetRouteResponse
	52,  // 179: pomerium.config.ConfigService.GetSettings:output_type -> pomerium.config.GetSettingsResponse
	54,  // 180: pomerium.config.ConfigService.ListKeyPairs:output_type -> pomerium.config.ListKeyPairsResponse
	56,  // 181: pomerium.config.ConfigService.ListPolicies:output_type -> pomerium.config.ListPoliciesResponse
	58,  // 182: pomerium.config.ConfigService.ListRoutes:output_type -> pomerium.config.ListRoutesResponse
	60,  // 183: pomerium.config.ConfigService.ListSettings:output_type -> pomerium.config.ListSettingsResponse
	62,  // 184: pomerium.config.ConfigService.UpdateKeyPair:output_type -> pomerium.config.UpdateKeyPairResponse
	64,  // 185: pomerium.config.ConfigService.UpdatePolicy:output_type -> pomerium.config.UpdatePolicyResponse
	66,  // 186: pomerium.config.ConfigService.UpdateRoute:output_type -> pomerium.config.UpdateRouteResponse
	68,  // 187: pomerium.config.ConfigService.UpdateSettings:output_type -> pomerium.config.UpdateSettingsResponse
	170, // [170:188] is the sub-list for method output_type
	152, // [152:170] is the sub-list for method input_type
