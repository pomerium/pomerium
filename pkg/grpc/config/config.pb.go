...
type Route struct {
	...
	AllowUpgrades []string `protobuf:"bytes,93,rep,name=allow_upgrades,json=allowUpgrades,proto3" json:"allow_upgrades,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Route) GetAllowUpgrades() []string {
	if x != nil {
...
const file_config_proto_rawDesc = "" +
	...
	"\x0enamespace_name\x18\\ \x01(\tH\x1dR\rnamespaceName\x88\x01\x01\x12%\n" +
	"\x0eallow_upgrades\x18] \x03(\tR\rallowUpgrades\x1a$\n" +
	"\n" +
	"StringList\x12\x16\n" +
