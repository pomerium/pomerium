...
type Settings struct {
	...
	LogToConsole       *bool                  `protobuf:"varint,177,opt,name=log_to_console,json=logToConsole,proto3,oneof" json:"log_to_console,omitempty"`
...
func (x *Settings) GetLogToConsole() bool {
	if x != nil && x.LogToConsole != nil {
...
const file_config_proto_rawDesc = "" +
	...
	"\f_explanationB\x0e\n" +
	"\f_remediationB\x11\n" +
	"\x0f_namespace_nameJ\x04\b\x04\x10\x05\"\xee_\n" +
	"\bSettings\x12\x14\n" +
	...
	"\x0elog_to_console\x18\xb1\x01 \x01(\bH\n" +
	"R\flogToConsole\x88\x01\x01\x12(\n" +
	"\rshared_secret\x18\x05 \x01(\tH\vR\fsharedSecret\x88\x01\x01\x12\x1f\n" +
	"\bservices\x18\x06 \x01(\tH\fR\bservices\x88\x01\x01\x12\x1d\n" +
	"\aaddress\x18\a \x01(\tH\rR\aaddress\x88\x01\x01\x12,\n" +
	"\x0finsecure_server\x18\b \x01(\bH\x0eR\x0einsecureServer\x88\x01\x01\x12X\n" +
	"\x18dns_failure_refresh_rate\x18\x99\x01 \x01(\v2\x19.google.protobuf.DurationH\x0fR\x15dnsFailureRefreshRate\x88\x01\x01\x12/\n" +
	"\x11dns_lookup_family\x18< \x01(\tH\x10R\x0fdnsLookupFamily\x88\x01\x01\x12K\n" +
	"\x11dns_query_timeout\x18\x95\x01 \x01(\v2\x19.google.protobuf.DurationH\x11R\x0fdnsQueryTimeout\x88\x01\x01\x12,\n" +
	"\x0fdns_query_tries\x18\x94\x01 \x01(\rH\x12R\rdnsQueryTries\x88\x01\x01\x12I\n" +
	"\x10dns_refresh_rate\x18\x9a\x01 \x01(\v2\x19.google.protobuf.DurationH\x13R\x0ednsRefreshRate\x88\x01\x01\x123\n" +
	"\x13dns_udp_max_queries\x18\x92\x01 \x01(\rH\x14R\x10dnsUdpMaxQueries\x88\x01\x01\x12$\n" +
	"\vdns_use_tcp\x18\x93\x01 \x01(\bH\x15R\tdnsUseTcp\x88\x01\x01\x12I\n" +
	...
	" \x01(\tH\x16R\x10httpRedirectAddr\x88\x01\x01\x12A\n" +
	"\ftimeout_read\x18\v \x01(\v2\x19.google.protobuf.DurationH\x17R\vtimeoutRead\x88\x01\x01\x12C\n" +
	"\rtimeout_write\x18\f \x01(\v2\x19.google.protobuf.DurationH\x18R\ftimeoutWrite\x88\x01\x01\x12A\n" +
	"\ftimeout_idle\x18\r \x01(\v2\x19.google.protobuf.DurationH\x19R\vtimeoutIdle\x88\x01\x01\x12=\n" +
	"\x18authenticate_service_url\x18\x0e \x01(\tH\x1aR\x16authenticateServiceUrl\x88\x01\x01\x12N\n" +
	"!authenticate_internal_service_url\x18R \x01(\tH\x1bR\x1eauthenticateInternalServiceUrl\x88\x01\x01\x125\n" +
	"\x14signout_redirect_url\x18] \x01(\tH\x1cR\x12signoutRedirectUrl\x88\x01\x01\x12$\n" +
	"\vcookie_name\x18\x10 \x01(\tH\x1dR\n" +
	"cookieName\x88\x01\x01\x12(\n" +
	"\rcookie_secret\x18\x11 \x01(\tH\x1eR\fcookieSecret\x88\x01\x01\x12(\n" +
	"\rcookie_domain\x18\x12 \x01(\tH\x1fR\fcookieDomain\x88\x01\x01\x12-\n" +
	"\x10cookie_http_only\x18\x14 \x01(\bH R\x0ecookieHttpOnly\x88\x01\x01\x12C\n" +
	...
	"\x14autocert_use_staging\x189 \x01(\bHUR\x12autocertUseStaging\x88\x01\x01\x122\n" +
	"\x13autocert_eab_key_id\x18N \x01(\tHVR\x10autocertEabKeyId\x88\x01\x01\x124\n" +
	"\x14autocert_eab_mac_key\x18O \x01(\tHWR\x11autocertEabMacKey\x88\x01\x01\x125\n" +
	...
	"\x10_proxy_log_levelB\x11\n" +
	"\x0f_log_to_consoleB\x10\n" +
