...
//go:generate ../../scripts/protoc -I ./config/ --go_out=M"envoy/config/cluster/v3/outlier_detection.proto"="github.com/envoyproxy/go-control-plane/envoy/config/cluster/v3",plugins=grpc,paths=source_relative:./config/. ./config/config.proto
