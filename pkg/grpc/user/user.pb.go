...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x04user\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"1\n" +
	"\x05Claim\x12\x10\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x1a.google.protobuf.ListValueR\x05value:\x028\x01\"\x96\x03\n" +
	"\x0eServiceAccount\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12&\n" +
	"\fnamespace_id\x18\b \x01(\tH\x00R\vnamespaceId\x88\x01\x01\x12(\n" +
	"\roriginator_id\x18\v \x01(\tH\x01R\foriginatorId\x88\x01\x01\x12%\n" +
