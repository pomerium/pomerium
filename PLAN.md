...
|----|-------|---------------------|
| [#6088](https://github.com/pomerium/pomerium/pull/6088) | mcp: host Client ID Metadata Documents for auto-discovery mode | CIMD endpoint for MCP clients |
| [#6091](https://github.com/pomerium/pomerium/pull/6091) | mcp: add ext_proc integration for response interception | ext_proc server scaffold, Envoy filter chain |
| [#6099](https://github.com/pomerium/pomerium/pull/6099) | mcp: add upstream OAuth discovery core functions (RFC 9728/8414) | `runDiscovery()`, PRM + AS metadata fetching |
| [#6100](https://github.com/pomerium/pomerium/pull/6100) | mcp: add upstream MCP token storage | Token CRUD, singleflight refresh |
| [#6107](https://github.com/pomerium/pomerium/pull/6107) | mcp: add UpstreamOAuthClient type and storage for DCR caching | Client registration caching |
| [#6109](https://github.com/pomerium/pomerium/pull/6109) | fix(mcp): CORS header consistency and e2e tests | CORS fixes, e2e test harness |
...
### [#6121](https://github.com/pomerium/pomerium/pull/6121) — databroker: add first-class record auto-expiry via Options TTL
...
### [#6118](https://github.com/pomerium/pomerium/pull/6118) — mcp: add PendingUpstreamAuth proto and storage methods
...
### [#6119](https://github.com/pomerium/pomerium/pull/6119) — mcp: pass upstream host via route context metadata and extend HostInfo
...
### PR 3: ext_proc handler interface + server request/response handling
...
### PR 4: Token exchange + upstream auth core implementation
...
### PR 5: OAuth callback + authorize changes + handler_connect refactoring + review findings tests
...
### PR 6: Controlplane wiring + e2e test update
**Files (2 files, +23/−2):**
