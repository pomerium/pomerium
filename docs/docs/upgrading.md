...
A back-end cache service was added to support user sessions refresh from [single-page-apps](https://en.wikipedia.org/wiki/Single-page_application). For more details as to why this was necessary, please see [PR438](https://github.com/pomerium/pomerium/pull/438) and [PR457](https://github.com/pomerium/pomerium/pull/457).
...
Please see the updated examples, and [cache service docs] as a reference. Consider the following changes made to the [split service example]:
