...
func Test_PolicyValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{"bad kube service account token file", config.Policy{From: "https://httpbin.corp.example", To: mustParseWeightedURLs(t, "https://internal-host-name"), KubernetesServiceAccountTokenFile: "testdata/missing.token"}, true},
...
func TestUnsafe(t *testing.T) {
	...
	randomString := func(rand *rand.Rand) string {
	...
	newRandomPolicy := func(rand *rand.Rand) *config.Policy {
		p := &config.Policy{
