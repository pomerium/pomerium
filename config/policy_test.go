...
func Test_PolicyValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{"allow_upgrades with TCP", Policy{From: "tcp+https://httpbin.corp.example:4000", To: mustParseWeightedURLs(t, "tcp://one.example.com:5000"), AllowUpgrades: []string{"test"}}, true},
		{"allow_upgrades with UDP", Policy{From: "udp+https://httpbin.corp.example:4000", To: mustParseWeightedURLs(t, "udp://one.example.com:5000"), AllowUpgrades: []string{"test"}}, true},
		{"allow_upgrades good", Policy{From: "https://httpbin.corp.example", To: mustParseWeightedURLs(t, "https://httpbin.corp.notatld"), AllowUpgrades: []string{"test"}}, false},
