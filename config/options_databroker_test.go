	...
	for _, tc := range []struct {
		...
		},
		{
			&configpb.Settings{DatabrokerClusterNodes: &configpb.Settings_DataBrokerClusterNodes{Nodes: []*configpb.Settings_DataBrokerClusterNode{
				{Id: "node-1", GrpcAddress: "http://node-1.example.com", RaftAddress: proto.String("node-1.example.com:5999")},
				{Id: "node-2", GrpcAddress: "http://node-2.example.com", RaftAddress: proto.String("node-2.example.com:5999")},
				{Id: "node-3", GrpcAddress: "http://node-3.example.com", RaftAddress: proto.String("node-3.example.com:5999")},
			}}},
			config.DataBrokerOptions{ClusterNodes: config.DataBrokerClusterNodes{
				{ID: "node-1", GRPCAddress: "http://node-1.example.com", RaftAddress: null.StringFrom("node-1.example.com:5999")},
				{ID: "node-2", GRPCAddress: "http://node-2.example.com", RaftAddress: null.StringFrom("node-2.example.com:5999")},
				{ID: "node-3", GRPCAddress: "http://node-3.example.com", RaftAddress: null.StringFrom("node-3.example.com:5999")},
			}},
		},
		{
