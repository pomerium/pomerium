...
func (b *ScopedBuilder) BuildBootstrap(
	ctx context.Context,
	fullyStatic bool,
	...
	bootstrap.Admin, err = b.BuildBootstrapAdmin(ctx)
	if err != nil {
		return nil, fmt.Errorf("error building bootstrap admin: %w", err)
	}

	bootstrap.DynamicResources, err = b.BuildBootstrapDynamicResources(ctx, fullyStatic)
	if err != nil {
	...
	bootstrap.StatsConfig, err = b.BuildBootstrapStatsConfig(ctx)
	if err != nil {
		return nil, err
	}
...
func (b *ScopedBuilder) BuildBootstrapAdmin(ctx context.Context) (admin *envoy_config_bootstrap_v3.Admin, err error) {
...
func (b *ScopedBuilder) BuildBootstrapDynamicResources(
	ctx context.Context,
	fullyStatic bool,
...
func (b *ScopedBuilder) BuildBootstrapLayeredRuntime(ctx context.Context) (*envoy_config_bootstrap_v3.LayeredRuntime, error) {
...
// cluster.
func (b *ScopedBuilder) BuildBootstrapStaticResources(
	ctx context.Context,
	fullyStatic bool,
...
func (b *ScopedBuilder) BuildBootstrapStatsConfig(ctx context.Context) (*envoy_config_metrics_v3.StatsConfig, error) {
