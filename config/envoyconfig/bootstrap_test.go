...
func TestBuilder_BuildBootstrapLayeredRuntime(t *testing.T) {
	b := New("localhost:1111", "localhost:2222", "localhost:3333", "/tmp/events", filemgr.NewManager(), nil)
...
func TestBuilder_BuildBootstrapStaticResources(t *testing.T) {
	...
	t.Run("bad gRPC address", func(t *testing.T) {
		b := New("xyz:zyx", "localhost:2222", "localhost:3333", "/tmp/events", filemgr.NewManager(), nil)
