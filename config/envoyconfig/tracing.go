...
func buildTracingConfig(opts *config.Options) *envoy_extensions_filters_network_http_connection_manager.HttpConnectionManager_Tracing {
	...
	return &envoy_extensions_filters_network_http_connection_manager.HttpConnectionManager_Tracing{
		RandomSampling:    &envoy_type_v3.Percent{Value: opts.TracingSampleRate * 100},
		Verbose:           true,
		SpawnUpstreamSpan: wrapperspb.Bool(true), // TODO: the effect this has is unclear
