...
require (
	...
	github.com/pomerium/datasource v0.18.2-0.20260901011857-6acc89ec7a4f
	...
	github.com/pomerium/protoutil v0.0.0-20260825170010-c341f47f6e18
	github.com/pomerium/webauthn v0.0.0-20260901011926-1804a5a9803a
