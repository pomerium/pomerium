...
require (
	...
	github.com/pomerium/envoy-custom v1.35.3-rc3.0.20251002011911-28bb78a3a445
...
replace github.com/evertras/bubble-table => github.com/kralicky/bubble-table v0.0.0-20250926184757-0de1495f3f13
