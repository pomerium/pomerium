...
require (
	...
	github.com/pomerium/envoy-custom v1.36.2-rc1.0.20251120234524-51bf1e57025a
...
require (
	...
	github.com/cockroachdb/datadriven v1.0.3-0.20250911232732-d959cf14706c // indirect
