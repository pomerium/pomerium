...
// EventDict returns a representation of this certificate matching the log
// format generated by controlplane.PopulateCertEventDict().
func (c *Certificate) EventDict() map[string]any {
	leaf := c.Leaf
...
func (e *environment) Start() {
	...
	cfg.Options.DatabrokerStorageType = new("memory")
