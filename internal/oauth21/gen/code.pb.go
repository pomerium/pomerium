...
const file_code_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"code.proto\x12\aoauth21\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcb\x01\n" +
	"\x04Code\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	...
	"\x0erecord_version\x18\x04 \x01(\x04R\rrecordVersion*o\n" +
	"\bCodeType\x12\x19\n" +
