...
const file_authorization_request_proto_rawDesc = "" +
	"\n" +
	"\x1bauthorization_request.proto\x12\aoauth21\x1a\x1bbuf/validate/validate.proto\"\xcb\x03\n" +
	...
	"\x15code_challenge_method\x18\a \x01(\tB\x12\xbaH\x0fr\rR\x04S256R\x05plainH\x03R\x13codeChallengeMethod\x88\x01\x01\x12\x1f\n" +
	"\auser_id\x18\t \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x06userIdB\x0f\n" +
	"\r_redirect_uriB\b\n" +
	"\x06_stateB\x11\n" +
	"\x0f_code_challengeB\x18\n" +
	"\x16_code_challenge_methodJ\x04\b\b\x10\tR\n" +
	"session_idB\x97\x01\n" +
