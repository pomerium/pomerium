...
type MCPRefreshToken struct {
	...
	// Current session id the refresh token is associated with
...
func (x *MCPRefreshToken) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
const file_mcp_refresh_token_proto_rawDesc = "" +
	"\n" +
	"\x17mcp_refresh_token.proto\x12\aoauth21\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8d\x03\n" +
