...
const file_rfc7591_types_proto_rawDesc = "" +
	...
	"\x01x\x18\x02 \x01(\tB\"\xbaH\x1f\xc8\x01\x01r\x1a\x10\x012\x16^[a-zA-Z0-9-_]+={0,2}$R\x01x\"\xb7\x11\n" +
	"\bMetadata\x126\n" +
	"\rredirect_uris\x18\x01 \x03(\tB\x11\xbaH\x0e\x92\x01\v\b\x01\"\ar\x05\x10\x01\x88\x01\x01R\fredirectUris\x12\x87\x01\n" +
	"\x1atoken_endpoint_auth_method\x18\x02 \x01(\tBE\xbaHBr@R\x04noneR\x12client_secret_postR\x13client_secret_basicR\x0fprivate_key_jwtH\x00R\x17tokenEndpointAuthMethod\x88\x01\x01\x12\x1f\n" +
