	...
	tests := []struct {
	...
	}{
		{
			...
			want: &Metadata{
				...
				TokenEndpointAuthMethod: new(TokenEndpointAuthMethodClientSecretBasic),
		...
		},
		{
			...
			want: &Metadata{
				...
				TosUri:          new("https://example.com/tos"),
				PolicyUri:       new("https://example.com/privacy"),
				JwksUri:         new("https://example.com/.well-known/jwks.json"),
				SoftwareId:      new("test-client-v1"),
...
func TestWriteRegistrationResponse(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			metadata: &Metadata{
				RedirectUris:            []string{"https://example.com/callback"},
				TokenEndpointAuthMethod: new(TokenEndpointAuthMethodNone),
				GrantTypes:              []string{GrantTypesAuthorizationCode},
				ResponseTypes:           []string{ResponseTypesCode},
			},
			want: map[string]any{
		...
		},
		{
			...
			metadata: &Metadata{
				RedirectUris:            []string{"https://example.com/callback"},
				TokenEndpointAuthMethod: new(TokenEndpointAuthMethodClientSecretPost),
		...
		},
		{
			...
			metadata: &Metadata{
				...
				ClientName:              new("Full Test Client"),
				ClientNameLocalized: map[string]string{
					"en": "Full Test Client",
				...
				PolicyUri:       new("https://example.com/privacy"),
				JwksUri:         new("https://example.com/.well-known/jwks.json"),
				SoftwareId:      new("test-software-v1"),
				SoftwareVersion: new("1.2.3"),
			},
			want: map[string]any{
