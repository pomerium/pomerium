...
func NewEndpoint(u *url.URL, ts *envoy_config_core_v3.TransportSocket, weight *wrappers.UInt32Value) Endpoint {
	return Endpoint{url: u, transportSocket: ts, loadBalancerWeight: weight}
}
