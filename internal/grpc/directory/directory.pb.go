...
func (x *DirectoryUser) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *DirectoryUser) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *DirectoryUser) GetGroups() []string {
	if x != nil {
		return x.Groups
	}
	return nil
...
var file_directory_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x5a, 0x0a, 0x0d,
	0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x55, 0x73, 0x65, 0x72, 0x12, 0x18, 0x0a,
	...
	0x52, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68,
	...
	0x6c, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79,
...
var file_directory_proto_goTypes = []interface{}{
	(*DirectoryUser)(nil), // 0: directory.DirectoryUser
}
